...
class MainWindow(QMainWindow):
    ...
    def __init__(self):
        ...
        self.setStyleSheet("background-color:#741fdb; font: 12pt Helvetica; color: #d3e1ed")
        self.setWindowIcon(QtGui.QIcon('C:\\Users\\sumit\\OneDrive\\Desktop\\Final_Minor_project\\Photocrypt-restructure\\Photocrypt-restructure\\bin\\logo1.png'))
        self.setWindowTitle("𝐏𝐄𝐍𝐂𝐑𝐘𝐏𝐓𝐈𝐎𝐍")
        ...
        self.subtitle = QLabel("Created by Mr_SK", self)
...
class ImageViewer(QWidget):
    ...
    def __init__(self, title, image, default_email=None):
        ...
        self.setStyleSheet("background-color:#315d90; font: 12pt Helvetica; color: white")
        self.setWindowTitle("Image Viewer - PENCRYPTION")
